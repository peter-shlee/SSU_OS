...
00000480 <writetest>:
{
  ...
  printf(stdout, "small file test ok\n");
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     5fe:	ff 35 e4 5d 00 00    	pushl  0x5de4
    ...
    printf(stdout, "read failed\n");
     ...
     615:	ff 35 e4 5d 00 00    	pushl  0x5de4
    ...
    printf(stdout, "unlink small failed\n");
     ...
     62c:	ff 35 e4 5d 00 00    	pushl  0x5de4
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     643:	ff 35 e4 5d 00 00    	pushl  0x5de4
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files ok\n");
     ...
     7ce:	ff 35 e4 5d 00 00    	pushl  0x5de4
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7e5:	ff 35 e4 5d 00 00    	pushl  0x5de4
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     7fc:	ff 35 e4 5d 00 00    	pushl  0x5de4
    ...
    printf(stdout, "unlink big failed\n");
     ...
     813:	ff 35 e4 5d 00 00    	pushl  0x5de4
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d40:	ff 35 e4 5d 00 00    	pushl  0x5de4
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e08:	6a 00                	push   $0x0
    2e0a:	e8 fb 0a 00 00       	call   390a <sbrk>
  c = sbrk(-4096);
    2e0f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e16:	89 c6                	mov    %eax,%esi
  c = sbrk(-4096);
    2e18:	e8 ed 0a 00 00       	call   390a <sbrk>
  ...
  c = sbrk(0);
    ...
    2e2c:	6a 00                	push   $0x0
    2e2e:	e8 d7 0a 00 00       	call   390a <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e47:	6a 00                	push   $0x0
    2e49:	e8 bc 0a 00 00       	call   390a <sbrk>
    2e4e:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    2e50:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2e57:	e8 ae 0a 00 00       	call   390a <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e6c:	6a 00                	push   $0x0
    2e6e:	e8 97 0a 00 00       	call   390a <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ec5:	e8 38 0a 00 00       	call   3902 <getpid>
    2eca:	89 c7                	mov    %eax,%edi
    pid = fork();
    2ecc:	e8 a9 09 00 00       	call   387a <fork>
    if(pid < 0){
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    wait();
    2ee5:	e8 a0 09 00 00       	call   388a <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2ef8:	50                   	push   %eax
    2ef9:	e8 94 09 00 00       	call   3892 <pipe>
    ...
    2f21:	e8 74 09 00 00       	call   389a <read>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    if((pids[i] = fork()) == 0){
    2f33:	e8 42 09 00 00       	call   387a <fork>
  ...
  c = sbrk(4096);
    ...
    2f9f:	50                   	push   %eax
    2fa0:	e8 0d 09 00 00       	call   38b2 <kill>
    wait();
    2fa5:	e8 e0 08 00 00       	call   388a <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fbd:	6a 00                	push   $0x0
    2fbf:	e8 46 09 00 00       	call   390a <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fd3:	ff 35 e4 5d 00 00    	pushl  0x5de4
    ...
    2ff4:	ff 35 e4 5d 00 00    	pushl  0x5de4
    2ffa:	e8 01 0a 00 00       	call   3a00 <printf>
      exit();
    2fff:	83 c4 20             	add    $0x20,%esp
    3002:	e8 7b 08 00 00       	call   3882 <exit>
    sbrk(-(sbrk(0) - oldbrk));
    3007:	83 ec 0c             	sub    $0xc,%esp
    300a:	6a 00                	push   $0x0
    300c:	e8 f9 08 00 00       	call   390a <sbrk>
    3011:	29 c3                	sub    %eax,%ebx
    3013:	89 1c 24             	mov    %ebx,(%esp)
    3016:	e8 ef 08 00 00       	call   390a <sbrk>
    ...
    3027:	ff 35 e4 5d 00 00    	pushl  0x5de4
    302d:	e8 ce 09 00 00       	call   3a00 <printf>
    exit();
    3032:	e8 4b 08 00 00       	call   3882 <exit>
    printf(1, "pipe() failed\n");
    3037:	52                   	push   %edx
    3038:	52                   	push   %edx
...
00003200 <bsstest>:
{
  ...
  printf(stdout, "bss test ok\n");
    ...
    324b:	ff 35 e4 5d 00 00    	pushl  0x5de4
    ...
    3263:	ff 35 e4 5d 00 00    	pushl  0x5de4
    3269:	e8 92 07 00 00       	call   3a00 <printf>
      exit();
    326e:	e8 0f 06 00 00       	call   3882 <exit>
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    328b:	e8 42 06 00 00       	call   38d2 <unlink>
  pid = fork();
    3290:	e8 e5 05 00 00       	call   387a <fork>
  if(pid == 0){
  ...
  wait();
    32a2:	e8 e3 05 00 00       	call   388a <wait>
  fd = open("bigarg-ok", 0);
    32a7:	83 ec 08             	sub    $0x8,%esp
    32aa:	6a 00                	push   $0x0
    32ac:	68 66 4c 00 00       	push   $0x4c66
    32b1:	e8 0c 06 00 00       	call   38c2 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32c4:	50                   	push   %eax
    32c5:	e8 e0 05 00 00       	call   38aa <close>
  unlink("bigarg-ok");
    32ca:	c7 04 24 66 4c 00 00 	movl   $0x4c66,(%esp)
    32d1:	e8 fc 05 00 00       	call   38d2 <unlink>
}
    ...
    32f7:	ff 35 e4 5d 00 00    	pushl  0x5de4
    args[MAXARG-1] = 0;
    ...
    3318:	e8 9d 05 00 00       	call   38ba <exec>
    printf(stdout, "bigarg test ok\n");
    331d:	59                   	pop    %ecx
    331e:	58                   	pop    %eax
    331f:	68 7d 4c 00 00       	push   $0x4c7d
    3324:	ff 35 e4 5d 00 00    	pushl  0x5de4
    ...
    333b:	e8 82 05 00 00       	call   38c2 <open>
    close(fd);
    3340:	89 04 24             	mov    %eax,(%esp)
    3343:	e8 62 05 00 00       	call   38aa <close>
    exit();
    3348:	e8 35 05 00 00       	call   3882 <exit>
    printf(stdout, "bigarg test failed!\n");
    334d:	50                   	push   %eax
    334e:	50                   	push   %eax
    334f:	68 a6 4c 00 00       	push   $0x4ca6
    3354:	ff 35 e4 5d 00 00    	pushl  0x5de4
    335a:	e8 a1 06 00 00       	call   3a00 <printf>
    exit();
    335f:	e8 1e 05 00 00       	call   3882 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3364:	52                   	push   %edx
    3365:	52                   	push   %edx
    3366:	68 8d 4c 00 00       	push   $0x4c8d
    336b:	ff 35 e4 5d 00 00    	pushl  0x5de4
    3371:	e8 8a 06 00 00       	call   3a00 <printf>
    exit();
    3376:	e8 07 05 00 00       	call   3882 <exit>
    337b:	90                   	nop
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    ...
    342a:	50                   	push   %eax
    342b:	e8 92 04 00 00       	call   38c2 <open>
    if(fd < 0){
    ...
    344f:	57                   	push   %edi
    3450:	e8 4d 04 00 00       	call   38a2 <write>
      if(cc < 512)
    ...
    3472:	e8 33 04 00 00       	call   38aa <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3519:	50                   	push   %eax
    351a:	e8 b3 03 00 00       	call   38d2 <unlink>
  while(nfiles >= 0){
...
00003550 <uio>:
{
  ...
  pid = fork();
    3562:	e8 13 03 00 00       	call   387a <fork>
  if(pid == 0){
  ...
  wait();
    3570:	e8 15 03 00 00       	call   388a <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35a8:	e8 d5 02 00 00       	call   3882 <exit>
    printf (1, "fork failed\n");
    35ad:	50                   	push   %eax
    35ae:	50                   	push   %eax
    ...
    exit();
    35bb:	e8 c2 02 00 00       	call   3882 <exit>
...
000035c0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35ce:	e8 ef 02 00 00       	call   38c2 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    35df:	6a 00                	push   $0x0
    35e1:	e8 24 03 00 00       	call   390a <sbrk>
    35e6:	83 c4 0c             	add    $0xc,%esp
    35e9:	83 e8 01             	sub    $0x1,%eax
    35ec:	6a ff                	push   $0xffffffff
    35ee:	50                   	push   %eax
    35ef:	53                   	push   %ebx
    35f0:	e8 a5 02 00 00       	call   389a <read>
  close(fd);
    35f5:	89 1c 24             	mov    %ebx,(%esp)
    35f8:	e8 ad 02 00 00       	call   38aa <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3621:	e8 5c 02 00 00       	call   3882 <exit>
    3626:	66 90                	xchg   %ax,%ax
    3628:	66 90                	xchg   %ax,%ax
    362a:	66 90                	xchg   %ax,%ax
    362c:	66 90                	xchg   %ax,%ax
...
00003932 <get_num_proc>:
SYSCALL(get_num_proc)
    3932:	b8 18 00 00 00       	mov    $0x18,%eax
    3937:	cd 40                	int    $0x40
    3939:	c3                   	ret    

0000393a <get_max_pid>:
SYSCALL(get_max_pid)
    393a:	b8 19 00 00 00       	mov    $0x19,%eax
    393f:	cd 40                	int    $0x40
    3941:	c3                   	ret    

00003942 <get_proc_info>:
SYSCALL(get_proc_info)
    3942:	b8 1a 00 00 00       	mov    $0x1a,%eax
    3947:	cd 40                	int    $0x40
    3949:	c3                   	ret    

0000394a <set_prio>:
SYSCALL(set_prio)
    394a:	b8 1b 00 00 00       	mov    $0x1b,%eax
    394f:	cd 40                	int    $0x40
    3951:	c3                   	ret    
    ...
    3969:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
    ...
    39d0:	e8 cd fe ff ff       	call   38a2 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3a40:	e8 5d fe ff ff       	call   38a2 <write>
  ...
  write(fd, &c, 1);
    ...
    3aa1:	e8 fc fd ff ff       	call   38a2 <write>
  ...
  write(fd, &c, 1);
    3aba:	e8 e3 fd ff ff       	call   38a2 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    3b53:	57                   	push   %edi
    3b54:	53                   	push   %ebx
    3b55:	e8 48 fd ff ff       	call   38a2 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3ba7:	e8 f6 fc ff ff       	call   38a2 <write>
        ap++;
    ...
    3bd1:	a1 80 5e 00 00       	mov    0x5e80,%eax
{
  ...
  freep = p;
    3c0f:	a3 80 5e 00 00       	mov    %eax,0x5e80
}
    3c14:	5b                   	pop    %ebx
    3c15:	5e                   	pop    %esi
    3c16:	5f                   	pop    %edi
    ...
    3c26:	72 ce                	jb     3bf6 <free+0x26>
{
  ...
  freep = p;
    3c4a:	a3 80 5e 00 00       	mov    %eax,0x5e80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cbe:	56                   	push   %esi
    3cbf:	e8 46 fc ff ff       	call   390a <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    ...
    3d04:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3d07:	89 15 80 5e 00 00    	mov    %edx,0x5e80
}
    ...
    base.s.ptr = freep = prevp = &base;
    3d20:	c7 05 80 5e 00 00 84 	movl   $0x5e84,0x5e80
    3d27:	5e 00 00 
    3d2a:	c7 05 84 5e 00 00 84 	movl   $0x5e84,0x5e84
    3d31:	5e 00 00 
    base.s.size = 0;
    3d34:	b8 84 5e 00 00       	mov    $0x5e84,%eax
    3d39:	c7 05 88 5e 00 00 00 	movl   $0x0,0x5e88
    3d40:	00 00 00 
