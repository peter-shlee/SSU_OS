...
int main(void)
{
  ...
  1b:	e8 30 04 00 00       	call   450 <printf>
	max_pid = get_max_pid();
  20:	e8 65 03 00 00       	call   38a <get_max_pid>
	for (pid = 0; pid <= max_pid; ++pid) {
  25:	83 c4 10             	add    $0x10,%esp
  28:	85 c0                	test   %eax,%eax
  2a:	78 41                	js     6d <main+0x6d>
  2c:	8d 70 01             	lea    0x1(%eax),%esi
  2f:	8d 7d dc             	lea    -0x24(%ebp),%edi
  ...
  69:	39 f3                	cmp    %esi,%ebx
  6b:	75 cb                	jne    38 <main+0x38>
		}
	}

    	exit();
  6d:	e8 60 02 00 00       	call   2d2 <exit>
  72:	66 90                	xchg   %ax,%ax
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
