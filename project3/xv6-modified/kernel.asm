...
801023a5:	68 e6 75 10 80       	push   $0x801075e6
...
8010240b:	68 ec 75 10 80       	push   $0x801075ec
...
80102583:	0f b6 82 20 77 10 80 	movzbl -0x7fef88e0(%edx),%eax
8010258a:	09 c1                	or     %eax,%ecx
  shift ^= togglecode[data];
8010258c:	0f b6 82 20 76 10 80 	movzbl -0x7fef89e0(%edx),%eax
...
801025a0:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
801025a3:	8b 04 85 00 76 10 80 	mov    -0x7fef8a00(,%eax,4),%eax
...
801025c5:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801025c8:	0f b6 82 20 77 10 80 	movzbl -0x7fef88e0(%edx),%eax
...
80102b1a:	68 20 78 10 80       	push   $0x80107820
...
80102d6f:	68 24 78 10 80       	push   $0x80107824
...
80102e39:	68 33 78 10 80       	push   $0x80107833
80102e3e:	e8 4d d5 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102e43:	83 ec 0c             	sub    $0xc,%esp
80102e46:	68 49 78 10 80       	push   $0x80107849
...
80102e68:	68 64 78 10 80       	push   $0x80107864
80102e6d:	e8 ee d7 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e72:	e8 59 2c 00 00       	call   80105ad0 <idtinit>
...
80102ef9:	e8 52 08 00 00       	call   80103750 <pinit>
  tvinit();        // trap vectors
80102efe:	e8 4d 2b 00 00       	call   80105a50 <tvinit>
  binit();         // buffer cache
...
80102ffe:	68 78 78 10 80       	push   $0x80107878
...
801030bc:	68 95 78 10 80       	push   $0x80107895
...
80103150:	ff 24 95 bc 78 10 80 	jmp    *-0x7fef8744(,%edx,4)
...
80103203:	68 7d 78 10 80       	push   $0x8010787d
80103208:	e8 83 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
8010320d:	83 ec 0c             	sub    $0xc,%esp
80103210:	68 9c 78 10 80       	push   $0x8010789c
...
80103308:	00 00 00 
  initlock(&p->lock, "pipe");
8010330b:	68 d0 78 10 80       	push   $0x801078d0
...
80103636:	81 fb 74 4f 11 80    	cmp    $0x80114f74,%ebx
...
80103663:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103669:	e8 c2 10 00 00       	call   80104730 <release>
...
8010368b:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010368e:	c7 40 14 41 5a 10 80 	movl   $0x80105a41,0x14(%eax)
  p->context = (struct context*)sp;
...
8010369d:	e8 de 10 00 00       	call   80104780 <memset>
...
801036c0:	c7 83 84 00 00 00 b8 	movl   $0xbb8,0x84(%ebx)
801036c7:	0b 00 00 
}
...
80103756:	68 d5 78 10 80       	push   $0x801078d5
...
80103853:	e8 b8 37 00 00       	call   80107010 <setupkvm>
...
80103871:	e8 7a 34 00 00       	call   80106cf0 <inituvm>
...
801038df:	68 05 79 10 80       	push   $0x80107905
801038e4:	50                   	push   %eax
801038e5:	e8 76 10 00 00       	call   80104960 <safestrcpy>
  p->cwd = namei("/");
801038ea:	c7 04 24 0e 79 10 80 	movl   $0x8010790e,(%esp)
...
80103923:	68 ec 78 10 80       	push   $0x801078ec
...
8010395c:	e8 7f 32 00 00       	call   80106be0 <switchuvm>
  return 0;
...
8010397a:	e8 b1 34 00 00       	call   80106e30 <allocuvm>
...
8010399a:	e8 c1 35 00 00       	call   80106f60 <deallocuvm>
...
801039e8:	e8 f3 36 00 00       	call   801070e0 <copyuvm>
...
80103aea:	00 00 00 
	srand(20160548);
80103aed:	68 24 a0 33 01       	push   $0x133a024
80103af2:	8d 73 04             	lea    0x4(%ebx),%esi
80103af5:	e8 06 38 00 00       	call   80107300 <srand>
...
80103b04:	bf 01 00 00 00       	mov    $0x1,%edi
		acquire(&ptable.lock);
80103b09:	68 40 2d 11 80       	push   $0x80112d40
80103b0e:	e8 5d 0b 00 00       	call   80104670 <acquire>
80103b13:	83 c4 10             	add    $0x10,%esp

    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b16:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103b1b:	90                   	nop
80103b1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(p->state == RUNNABLE)
80103b20:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103b24:	75 06                	jne    80103b2c <scheduler+0x5c>
	ticket_total += p->ticket;
80103b26:	03 b8 84 00 00 00    	add    0x84(%eax),%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b2c:	05 88 00 00 00       	add    $0x88,%eax
80103b31:	3d 74 4f 11 80       	cmp    $0x80114f74,%eax
80103b36:	72 e8                	jb     80103b20 <scheduler+0x50>
		random_number = rand() % ticket_total + 1;
80103b38:	e8 73 37 00 00       	call   801072b0 <rand>
80103b3d:	31 d2                	xor    %edx,%edx
80103b3f:	f7 f7                	div    %edi
		ticket_count = 0;
80103b41:	31 c0                	xor    %eax,%eax
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b43:	bf 74 2d 11 80       	mov    $0x80112d74,%edi
		random_number = rand() % ticket_total + 1;
80103b48:	83 c2 01             	add    $0x1,%edx
80103b4b:	eb 11                	jmp    80103b5e <scheduler+0x8e>
80103b4d:	8d 76 00             	lea    0x0(%esi),%esi
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b50:	81 c7 88 00 00 00    	add    $0x88,%edi
80103b56:	81 ff 74 4f 11 80    	cmp    $0x80114f74,%edi
80103b5c:	73 47                	jae    80103ba5 <scheduler+0xd5>
			if(p->state == RUNNABLE) {
80103b5e:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103b62:	75 ec                	jne    80103b50 <scheduler+0x80>
				ticket_count += p->ticket;
80103b64:	03 87 84 00 00 00    	add    0x84(%edi),%eax
				if (random_number <= ticket_count) {
80103b6a:	39 c2                	cmp    %eax,%edx
80103b6c:	77 e2                	ja     80103b50 <scheduler+0x80>
					p->context_switch_count += 1;
80103b6e:	83 47 7c 01          	addl   $0x1,0x7c(%edi)
					switchuvm(p);
80103b72:	83 ec 0c             	sub    $0xc,%esp
					c->proc = p;
80103b75:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
					switchuvm(p);
80103b7b:	57                   	push   %edi
80103b7c:	e8 5f 30 00 00       	call   80106be0 <switchuvm>
					p->state = RUNNING;
80103b81:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
					swtch(&(c->scheduler), p->context);
80103b88:	58                   	pop    %eax
80103b89:	5a                   	pop    %edx
80103b8a:	ff 77 1c             	pushl  0x1c(%edi)
80103b8d:	56                   	push   %esi
80103b8e:	e8 28 0e 00 00       	call   801049bb <swtch>
					switchkvm();
80103b93:	e8 28 30 00 00       	call   80106bc0 <switchkvm>
					c->proc = 0;
80103b98:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103b9f:	00 00 00 
					break;
80103ba2:	83 c4 10             	add    $0x10,%esp
		release(&ptable.lock);
80103ba5:	83 ec 0c             	sub    $0xc,%esp
80103ba8:	68 40 2d 11 80       	push   $0x80112d40
80103bad:	e8 7e 0b 00 00       	call   80104730 <release>
		sti();
80103bb2:	83 c4 10             	add    $0x10,%esp
80103bb5:	e9 46 ff ff ff       	jmp    80103b00 <scheduler+0x30>
...
80103bc4:	53                   	push   %ebx
  pushcli();
80103bc5:	e8 d6 09 00 00       	call   801045a0 <pushcli>
  c = mycpu();
80103bca:	e8 a1 fb ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103bcf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bd5:	e8 06 0a 00 00       	call   801045e0 <popcli>
  if(!holding(&ptable.lock))
80103bda:	83 ec 0c             	sub    $0xc,%esp
80103bdd:	68 40 2d 11 80       	push   $0x80112d40
80103be2:	e8 59 0a 00 00       	call   80104640 <holding>
80103be7:	83 c4 10             	add    $0x10,%esp
80103bea:	85 c0                	test   %eax,%eax
80103bec:	74 53                	je     80103c41 <sched+0x81>
  if(mycpu()->ncli != 1)
80103bee:	e8 7d fb ff ff       	call   80103770 <mycpu>
80103bf3:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
80103bfa:	75 6c                	jne    80103c68 <sched+0xa8>
  if(p->state == RUNNING)
80103bfc:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
80103c00:	74 59                	je     80103c5b <sched+0x9b>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80103c02:	9c                   	pushf  
80103c03:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103c04:	f6 c4 02             	test   $0x2,%ah
80103c07:	75 45                	jne    80103c4e <sched+0x8e>
  p->context_switch_count += 1;
80103c09:	83 43 7c 01          	addl   $0x1,0x7c(%ebx)
  swtch(&p->context, mycpu()->scheduler);
80103c0d:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103c10:	e8 5b fb ff ff       	call   80103770 <mycpu>
80103c15:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103c1b:	e8 50 fb ff ff       	call   80103770 <mycpu>
80103c20:	83 ec 08             	sub    $0x8,%esp
80103c23:	ff 70 04             	pushl  0x4(%eax)
80103c26:	53                   	push   %ebx
80103c27:	e8 8f 0d 00 00       	call   801049bb <swtch>
  mycpu()->intena = intena;
80103c2c:	e8 3f fb ff ff       	call   80103770 <mycpu>
}
80103c31:	83 c4 10             	add    $0x10,%esp
  mycpu()->intena = intena;
80103c34:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
...
80103c44:	68 10 79 10 80       	push   $0x80107910
80103c49:	e8 42 c7 ff ff       	call   80100390 <panic>
    panic("sched interruptible");
80103c4e:	83 ec 0c             	sub    $0xc,%esp
80103c51:	68 3c 79 10 80       	push   $0x8010793c
80103c56:	e8 35 c7 ff ff       	call   80100390 <panic>
    panic("sched running");
80103c5b:	83 ec 0c             	sub    $0xc,%esp
80103c5e:	68 2e 79 10 80       	push   $0x8010792e
80103c63:	e8 28 c7 ff ff       	call   80100390 <panic>
    panic("sched locks");
80103c68:	83 ec 0c             	sub    $0xc,%esp
80103c6b:	68 22 79 10 80       	push   $0x80107922
80103c70:	e8 1b c7 ff ff       	call   80100390 <panic>
...
80103c86:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c89:	e8 12 09 00 00       	call   801045a0 <pushcli>
  c = mycpu();
80103c8e:	e8 dd fa ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103c93:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c99:	e8 42 09 00 00       	call   801045e0 <popcli>
  if(curproc == initproc)
...
80103ce4:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103ceb:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103cf2:	e8 79 09 00 00       	call   80104670 <acquire>
  wakeup1(curproc->parent);
80103cf7:	8b 56 14             	mov    0x14(%esi),%edx
80103cfa:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cfd:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103d02:	eb 10                	jmp    80103d14 <exit+0x94>
80103d04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d08:	05 88 00 00 00       	add    $0x88,%eax
80103d0d:	3d 74 4f 11 80       	cmp    $0x80114f74,%eax
...
80103d1f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d26:	05 88 00 00 00       	add    $0x88,%eax
80103d2b:	3d 74 4f 11 80       	cmp    $0x80114f74,%eax
80103d30:	72 e2                	jb     80103d14 <exit+0x94>
      p->parent = initproc;
80103d32:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d38:	ba 74 2d 11 80       	mov    $0x80112d74,%edx
80103d3d:	eb 0f                	jmp    80103d4e <exit+0xce>
80103d3f:	90                   	nop
80103d40:	81 c2 88 00 00 00    	add    $0x88,%edx
80103d46:	81 fa 74 4f 11 80    	cmp    $0x80114f74,%edx
...
80103d5a:	75 e4                	jne    80103d40 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d5c:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103d61:	eb 11                	jmp    80103d74 <exit+0xf4>
80103d63:	90                   	nop
80103d64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d68:	05 88 00 00 00       	add    $0x88,%eax
80103d6d:	3d 74 4f 11 80       	cmp    $0x80114f74,%eax
...
80103d97:	68 5d 79 10 80       	push   $0x8010795d
80103d9c:	e8 ef c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103da1:	83 ec 0c             	sub    $0xc,%esp
80103da4:	68 50 79 10 80       	push   $0x80107950
...
80103db7:	68 40 2d 11 80       	push   $0x80112d40
80103dbc:	e8 af 08 00 00       	call   80104670 <acquire>
  pushcli();
80103dc1:	e8 da 07 00 00       	call   801045a0 <pushcli>
  c = mycpu();
80103dc6:	e8 a5 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103dcb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103dd1:	e8 0a 08 00 00       	call   801045e0 <popcli>
...
80103de9:	e8 42 09 00 00       	call   80104730 <release>
}
...
80103e0c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e0f:	e8 8c 07 00 00       	call   801045a0 <pushcli>
  c = mycpu();
80103e14:	e8 57 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103e19:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e1f:	e8 bc 07 00 00       	call   801045e0 <popcli>
  if(p == 0)
...
80103e30:	81 fe 40 2d 11 80    	cmp    $0x80112d40,%esi
80103e36:	74 50                	je     80103e88 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103e38:	83 ec 0c             	sub    $0xc,%esp
80103e3b:	68 40 2d 11 80       	push   $0x80112d40
80103e40:	e8 2b 08 00 00       	call   80104670 <acquire>
    release(lk);
80103e45:	89 34 24             	mov    %esi,(%esp)
80103e48:	e8 e3 08 00 00       	call   80104730 <release>
  p->chan = chan;
...
80103e6a:	e8 c1 08 00 00       	call   80104730 <release>
    acquire(lk);
...
80103e7b:	5d                   	pop    %ebp
    acquire(lk);
80103e7c:	e9 ef 07 00 00       	jmp    80104670 <acquire>
...
80103ea9:	68 6f 79 10 80       	push   $0x8010796f
80103eae:	e8 dd c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103eb3:	83 ec 0c             	sub    $0xc,%esp
80103eb6:	68 69 79 10 80       	push   $0x80107969
...
80103ec4:	53                   	push   %ebx
  pushcli();
80103ec5:	e8 d6 06 00 00       	call   801045a0 <pushcli>
  c = mycpu();
80103eca:	e8 a1 f8 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103ecf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ed5:	e8 06 07 00 00       	call   801045e0 <popcli>
  acquire(&ptable.lock);
80103eda:	83 ec 0c             	sub    $0xc,%esp
80103edd:	68 40 2d 11 80       	push   $0x80112d40
80103ee2:	e8 89 07 00 00       	call   80104670 <acquire>
80103ee7:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103eea:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103eec:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
80103ef1:	eb 13                	jmp    80103f06 <wait+0x46>
80103ef3:	90                   	nop
80103ef4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103ef8:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103efe:	81 fb 74 4f 11 80    	cmp    $0x80114f74,%ebx
...
80103f17:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f1c:	81 fb 74 4f 11 80    	cmp    $0x80114f74,%ebx
...
80103f32:	68 40 2d 11 80       	push   $0x80112d40
...
80103f5a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f61:	e8 2a 30 00 00       	call   80106f90 <freevm>
        release(&ptable.lock);
80103f66:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
        p->pid = 0;
...
80103f86:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f8d:	e8 9e 07 00 00       	call   80104730 <release>
        return pid;
...
80103fa1:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103fa6:	68 40 2d 11 80       	push   $0x80112d40
80103fab:	e8 80 07 00 00       	call   80104730 <release>
      return -1;
...
80103fcf:	e8 9c 06 00 00       	call   80104670 <acquire>
...
80103fe5:	3d 74 4f 11 80       	cmp    $0x80114f74,%eax
...
80104003:	3d 74 4f 11 80       	cmp    $0x80114f74,%eax
80104008:	72 e2                	jb     80103fec <wakeup+0x2c>
  release(&ptable.lock);
8010400a:	c7 45 08 40 2d 11 80 	movl   $0x80112d40,0x8(%ebp)
}
80104011:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104014:	c9                   	leave  
  release(&ptable.lock);
80104015:	e9 16 07 00 00       	jmp    80104730 <release>
...
80104027:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010402a:	68 40 2d 11 80       	push   $0x80112d40
8010402f:	e8 3c 06 00 00       	call   80104670 <acquire>
80104034:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104037:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
8010403c:	eb 0e                	jmp    8010404c <kill+0x2c>
8010403e:	66 90                	xchg   %ax,%ax
80104040:	05 88 00 00 00       	add    $0x88,%eax
80104045:	3d 74 4f 11 80       	cmp    $0x80114f74,%eax
...
80104068:	68 40 2d 11 80       	push   $0x80112d40
8010406d:	e8 be 06 00 00       	call   80104730 <release>
      return 0;
...
80104083:	68 40 2d 11 80       	push   $0x80112d40
80104088:	e8 a3 06 00 00       	call   80104730 <release>
  return -1;
...
801040a6:	8d 75 e8             	lea    -0x18(%ebp),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040a9:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
{
...
801040bb:	68 27 7d 10 80       	push   $0x80107d27
801040c0:	e8 9b c5 ff ff       	call   80100660 <cprintf>
801040c5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040c8:	81 c3 88 00 00 00    	add    $0x88,%ebx
801040ce:	81 fb 74 4f 11 80    	cmp    $0x80114f74,%ebx
...
801040e1:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801040e4:	ba 80 79 10 80       	mov    $0x80107980,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040e9:	77 11                	ja     801040fc <procdump+0x5c>
801040eb:	8b 14 85 e0 79 10 80 	mov    -0x7fef8620(,%eax,4),%edx
      state = "???";
801040f2:	b8 80 79 10 80       	mov    $0x80107980,%eax
...
80104104:	68 84 79 10 80       	push   $0x80107984
...
8010412b:	e8 20 04 00 00       	call   80104550 <getcallerpcs>
...
80104149:	68 c1 73 10 80       	push   $0x801073c1
...
80104176:	83 ec 10             	sub    $0x10,%esp
	acquire(&ptable.lock);
80104179:	68 40 2d 11 80       	push   $0x80112d40
8010417e:	e8 ed 04 00 00       	call   80104670 <acquire>
80104183:	83 c4 10             	add    $0x10,%esp
	for (p = ptable.proc; p < &ptable.proc[NPROC]; ++p) {
80104186:	ba 74 2d 11 80       	mov    $0x80112d74,%edx
8010418b:	90                   	nop
...
80104194:	83 db ff             	sbb    $0xffffffff,%ebx
	for (p = ptable.proc; p < &ptable.proc[NPROC]; ++p) {
80104197:	81 c2 88 00 00 00    	add    $0x88,%edx
8010419d:	81 fa 74 4f 11 80    	cmp    $0x80114f74,%edx
801041a3:	72 eb                	jb     80104190 <get_num_proc+0x20>
	release(&ptable.lock);
801041a5:	83 ec 0c             	sub    $0xc,%esp
801041a8:	68 40 2d 11 80       	push   $0x80112d40
801041ad:	e8 7e 05 00 00       	call   80104730 <release>
}
...
801041c6:	83 ec 10             	sub    $0x10,%esp
	acquire(&ptable.lock);
801041c9:	68 40 2d 11 80       	push   $0x80112d40
801041ce:	e8 9d 04 00 00       	call   80104670 <acquire>
801041d3:	83 c4 10             	add    $0x10,%esp
	for (p = ptable.proc; p < &ptable.proc[NPROC]; ++p) {
801041d6:	ba 74 2d 11 80       	mov    $0x80112d74,%edx
801041db:	90                   	nop
...
801041e5:	74 08                	je     801041ef <get_max_pid+0x2f>
801041e7:	8b 42 10             	mov    0x10(%edx),%eax
801041ea:	39 c3                	cmp    %eax,%ebx
801041ec:	0f 4c d8             	cmovl  %eax,%ebx
	for (p = ptable.proc; p < &ptable.proc[NPROC]; ++p) {
801041ef:	81 c2 88 00 00 00    	add    $0x88,%edx
801041f5:	81 fa 74 4f 11 80    	cmp    $0x80114f74,%edx
801041fb:	72 e3                	jb     801041e0 <get_max_pid+0x20>
	release(&ptable.lock);
801041fd:	83 ec 0c             	sub    $0xc,%esp
80104200:	68 40 2d 11 80       	push   $0x80112d40
80104205:	e8 26 05 00 00       	call   80104730 <release>
}
8010420a:	89 d8                	mov    %ebx,%eax
8010420c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010420f:	c9                   	leave  
80104210:	c3                   	ret    
80104211:	eb 0d                	jmp    80104220 <get_proc_info>
80104213:	90                   	nop
80104214:	90                   	nop
80104215:	90                   	nop
80104216:	90                   	nop
...
80104225:	8b 75 0c             	mov    0xc(%ebp),%esi
80104228:	8b 5d 08             	mov    0x8(%ebp),%ebx
	acquire(&ptable.lock);
8010422b:	83 ec 0c             	sub    $0xc,%esp
8010422e:	68 40 2d 11 80       	push   $0x80112d40
80104233:	e8 38 04 00 00       	call   80104670 <acquire>
80104238:	83 c4 10             	add    $0x10,%esp
	for (p = ptable.proc; p < &ptable.proc[NPROC]; ++p) {
8010423b:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80104240:	eb 12                	jmp    80104254 <get_proc_info+0x34>
80104242:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104248:	05 88 00 00 00       	add    $0x88,%eax
8010424d:	3d 74 4f 11 80       	cmp    $0x80114f74,%eax
80104252:	73 4c                	jae    801042a0 <get_proc_info+0x80>
		if (p->state != UNUSED && p->pid == pid) {
80104254:	8b 50 0c             	mov    0xc(%eax),%edx
80104257:	85 d2                	test   %edx,%edx
80104259:	74 ed                	je     80104248 <get_proc_info+0x28>
8010425b:	39 58 10             	cmp    %ebx,0x10(%eax)
8010425e:	75 e8                	jne    80104248 <get_proc_info+0x28>
			if (p->parent == 0) {
80104260:	8b 50 14             	mov    0x14(%eax),%edx
80104263:	85 d2                	test   %edx,%edx
80104265:	74 29                	je     80104290 <get_proc_info+0x70>
				pInfo->ppid = p->parent->pid;
80104267:	8b 52 10             	mov    0x10(%edx),%edx
8010426a:	89 16                	mov    %edx,(%esi)
			pInfo->psize = p->sz;
8010426c:	8b 10                	mov    (%eax),%edx
	release(&ptable.lock);
8010426e:	83 ec 0c             	sub    $0xc,%esp
			pInfo->psize = p->sz;
80104271:	89 56 04             	mov    %edx,0x4(%esi)
			pInfo->numberContextSwitches = p->context_switch_count;
80104274:	8b 40 7c             	mov    0x7c(%eax),%eax
80104277:	89 46 08             	mov    %eax,0x8(%esi)
	release(&ptable.lock);
8010427a:	68 40 2d 11 80       	push   $0x80112d40
8010427f:	e8 ac 04 00 00       	call   80104730 <release>
...
8010428f:	c3                   	ret    
				pInfo->ppid = 0;
80104290:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80104296:	eb d4                	jmp    8010426c <get_proc_info+0x4c>
80104298:	90                   	nop
...
801042c5:	8b 5d 08             	mov    0x8(%ebp),%ebx
	if (0 < n && n <= 1000) {
801042c8:	8d 43 ff             	lea    -0x1(%ebx),%eax
801042cb:	3d e7 03 00 00       	cmp    $0x3e7,%eax
801042d0:	77 5e                	ja     80104330 <set_prio+0x70>
  pushcli();
801042d2:	e8 c9 02 00 00       	call   801045a0 <pushcli>
  c = mycpu();
801042d7:	e8 94 f4 ff ff       	call   80103770 <mycpu>
  p = c->proc;
801042dc:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801042e2:	e8 f9 02 00 00       	call   801045e0 <popcli>
		acquire(&ptable.lock);
801042e7:	83 ec 0c             	sub    $0xc,%esp
801042ea:	68 40 2d 11 80       	push   $0x80112d40
801042ef:	e8 7c 03 00 00       	call   80104670 <acquire>
	p->ticket = p->prio + (p->prio / 10) * (p->prio / 10);
801042f4:	89 d8                	mov    %ebx,%eax
801042f6:	ba cd cc cc cc       	mov    $0xcccccccd,%edx
		p->prio = n;
801042fb:	89 9e 80 00 00 00    	mov    %ebx,0x80(%esi)
	p->ticket = p->prio + (p->prio / 10) * (p->prio / 10);
80104301:	f7 e2                	mul    %edx
80104303:	c1 ea 03             	shr    $0x3,%edx
80104306:	0f af d2             	imul   %edx,%edx
80104309:	01 d3                	add    %edx,%ebx
8010430b:	89 9e 84 00 00 00    	mov    %ebx,0x84(%esi)
		release(&ptable.lock);
80104311:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80104335:	eb eb                	jmp    80104322 <set_prio+0x62>
...
80104344:	83 ec 10             	sub    $0x10,%esp
	acquire(&ptable.lock);
80104347:	68 40 2d 11 80       	push   $0x80112d40
8010434c:	e8 1f 03 00 00       	call   80104670 <acquire>
  pushcli();
80104351:	e8 4a 02 00 00       	call   801045a0 <pushcli>
  c = mycpu();
80104356:	e8 15 f4 ff ff       	call   80103770 <mycpu>
  p = c->proc;
8010435b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104361:	e8 7a 02 00 00       	call   801045e0 <popcli>
	n = myproc()->prio;
80104366:	8b 9b 80 00 00 00    	mov    0x80(%ebx),%ebx
	release(&ptable.lock);
8010436c:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80104373:	e8 b8 03 00 00       	call   80104730 <release>
	if (n > 0) {
80104378:	83 c4 10             	add    $0x10,%esp
8010437b:	85 db                	test   %ebx,%ebx
8010437d:	7e 11                	jle    80104390 <get_prio+0x50>
}
8010437f:	89 d8                	mov    %ebx,%eax
...
80104389:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
		return -1;
80104390:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104395:	eb e8                	jmp    8010437f <get_prio+0x3f>
80104397:	89 f6                	mov    %esi,%esi
80104399:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

801043a0 <update_ticket>:
{
801043a0:	55                   	push   %ebp
	p->ticket = p->prio + (p->prio / 10) * (p->prio / 10);
801043a1:	ba cd cc cc cc       	mov    $0xcccccccd,%edx
{
801043a6:	89 e5                	mov    %esp,%ebp
801043a8:	53                   	push   %ebx
801043a9:	8b 4d 08             	mov    0x8(%ebp),%ecx
	p->ticket = p->prio + (p->prio / 10) * (p->prio / 10);
801043ac:	8b 99 80 00 00 00    	mov    0x80(%ecx),%ebx
801043b2:	89 d8                	mov    %ebx,%eax
801043b4:	f7 e2                	mul    %edx
801043b6:	c1 ea 03             	shr    $0x3,%edx
801043b9:	0f af d2             	imul   %edx,%edx
801043bc:	01 d3                	add    %edx,%ebx
801043be:	89 99 84 00 00 00    	mov    %ebx,0x84(%ecx)
}
801043c4:	5b                   	pop    %ebx
801043c5:	5d                   	pop    %ebp
801043c6:	c3                   	ret    
...
801043d0 <get_ticket_total>:
get_ticket_total() { // lock한 뒤에 호출해야 함
801043d0:	55                   	push   %ebp
    unsigned int ticket_total = 1;
801043d1:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043d6:	ba 74 2d 11 80       	mov    $0x80112d74,%edx
get_ticket_total() { // lock한 뒤에 호출해야 함
801043db:	89 e5                	mov    %esp,%ebp
801043dd:	8d 76 00             	lea    0x0(%esi),%esi
      if(p->state == RUNNABLE)
801043e0:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
801043e4:	75 06                	jne    801043ec <get_ticket_total+0x1c>
	ticket_total += p->ticket;
801043e6:	03 82 84 00 00 00    	add    0x84(%edx),%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043ec:	81 c2 88 00 00 00    	add    $0x88,%edx
801043f2:	81 fa 74 4f 11 80    	cmp    $0x80114f74,%edx
801043f8:	72 e6                	jb     801043e0 <get_ticket_total+0x10>
    }
...
8010440a:	68 f8 79 10 80       	push   $0x801079f8
...
801044c4:	e8 f7 fa ff ff       	call   80103fc0 <wakeup>
  release(&lk->lk);
...
80104625:	68 03 7a 10 80       	push   $0x80107a03
8010462a:	e8 61 bd ff ff       	call   80100390 <panic>
    panic("popcli");
8010462f:	83 ec 0c             	sub    $0xc,%esp
80104632:	68 1a 7a 10 80       	push   $0x80107a1a
...
80104717:	68 21 7a 10 80       	push   $0x80107a21
...
8010476c:	68 29 7a 10 80       	push   $0x80107a29
...
80104b8c:	8b 14 85 60 7a 10 80 	mov    -0x7fef85a0(,%eax,4),%edx
...
80104bb0:	68 31 7a 10 80       	push   $0x80107a31
...
80104d04:	68 f0 7a 10 80       	push   $0x80107af0
...
80104d1c:	68 ef 7a 10 80       	push   $0x80107aef
...
80104d35:	68 e3 7a 10 80       	push   $0x80107ae3
...
80104d4a:	68 f2 7a 10 80       	push   $0x80107af2
80104d4f:	e8 3c b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104d54:	83 ec 0c             	sub    $0xc,%esp
80104d57:	68 d4 7a 10 80       	push   $0x80107ad4
...
80105149:	58                   	pop    %eax
8010514a:	5a                   	pop    %edx
8010514b:	68 f0 7a 10 80       	push   $0x80107af0
...
80105164:	68 ef 7a 10 80       	push   $0x80107aef
...
801057c3:	83 ec 08             	sub    $0x8,%esp
  exit();
801057c6:	e8 b5 e4 ff ff       	call   80103c80 <exit>
...
801057d3:	5d                   	pop    %ebp
  return wait();
801057d4:	e9 e7 e6 ff ff       	jmp    80103ec0 <wait>
...
801057fe:	e8 1d e8 ff ff       	call   80104020 <kill>
...
801058a0:	68 80 4f 11 80       	push   $0x80114f80
...
801058ad:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801058b0:	8b 1d c0 57 11 80    	mov    0x801157c0,%ebx
  while(ticks - ticks0 < n){
...
801058c3:	68 80 4f 11 80       	push   $0x80114f80
801058c8:	68 c0 57 11 80       	push   $0x801157c0
801058cd:	e8 2e e5 ff ff       	call   80103e00 <sleep>
  while(ticks - ticks0 < n){
801058d2:	a1 c0 57 11 80       	mov    0x801157c0,%eax
...
801058f0:	68 80 4f 11 80       	push   $0x80114f80
...
80105913:	68 80 4f 11 80       	push   $0x80114f80
...
80105934:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105937:	68 80 4f 11 80       	push   $0x80114f80
8010593c:	e8 2f ed ff ff       	call   80104670 <acquire>
  xticks = ticks;
80105941:	8b 1d c0 57 11 80    	mov    0x801157c0,%ebx
  release(&tickslock);
80105947:	c7 04 24 80 4f 11 80 	movl   $0x80114f80,(%esp)
...
80105963:	83 ec 14             	sub    $0x14,%esp
	cprintf("helloxv6\n");
80105966:	68 35 7b 10 80       	push   $0x80107b35
...
80105996:	68 3f 7b 10 80       	push   $0x80107b3f
...
801059b3:	5d                   	pop    %ebp
	return get_num_proc();
801059b4:	e9 b7 e7 ff ff       	jmp    80104170 <get_num_proc>
801059b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801059c0 <do_get_max_pid>:
...
801059c3:	5d                   	pop    %ebp
	return get_max_pid();
801059c4:	e9 f7 e7 ff ff       	jmp    801041c0 <get_max_pid>
801059c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801059d0 <do_get_proc_info>:
...
801059dc:	e8 9f f0 ff ff       	call   80104a80 <argint>
	argptr(1, (void *)&pInfo, sizeof(pInfo));
801059e1:	8d 45 f4             	lea    -0xc(%ebp),%eax
801059e4:	83 c4 0c             	add    $0xc,%esp
801059e7:	6a 04                	push   $0x4
801059e9:	50                   	push   %eax
801059ea:	6a 01                	push   $0x1
801059ec:	e8 df f0 ff ff       	call   80104ad0 <argptr>

	return get_proc_info(pid, pInfo);
801059f1:	58                   	pop    %eax
801059f2:	5a                   	pop    %edx
801059f3:	ff 75 f4             	pushl  -0xc(%ebp)
801059f6:	ff 75 f0             	pushl  -0x10(%ebp)
801059f9:	e8 22 e8 ff ff       	call   80104220 <get_proc_info>
}
801059fe:	c9                   	leave  
801059ff:	c3                   	ret    

80105a00 <do_set_prio>:
...
80105a15:	e8 a6 e8 ff ff       	call   801042c0 <set_prio>
}
80105a1a:	c9                   	leave  
80105a1b:	c3                   	ret    
80105a1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105a20 <do_get_prio>:
...
80105a23:	5d                   	pop    %ebp
	return get_prio();
80105a24:	e9 17 e9 ff ff       	jmp    80104340 <get_prio>
...
80105a2a:	06                   	push   %es
  pushl %fs
80105a2b:	0f a0                	push   %fs
  pushl %gs
80105a2d:	0f a8                	push   %gs
  pushal
80105a2f:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105a30:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105a34:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105a36:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105a38:	54                   	push   %esp
  call trap
80105a39:	e8 c2 00 00 00       	call   80105b00 <trap>
  addl $4, %esp
80105a3e:	83 c4 04             	add    $0x4,%esp
...
80105a41:	61                   	popa   
  popl %gs
80105a42:	0f a9                	pop    %gs
  popl %fs
80105a44:	0f a1                	pop    %fs
  popl %es
80105a46:	07                   	pop    %es
  popl %ds
80105a47:	1f                   	pop    %ds
...
80105a67:	c7 04 c5 c2 4f 11 80 	movl   $0x8e000008,-0x7feeb03e(,%eax,8)
80105a6e:	08 00 00 8e 
80105a72:	66 89 14 c5 c0 4f 11 	mov    %dx,-0x7feeb040(,%eax,8)
80105a79:	80 
80105a7a:	c1 ea 10             	shr    $0x10,%edx
80105a7d:	66 89 14 c5 c6 4f 11 	mov    %dx,-0x7feeb03a(,%eax,8)
80105a84:	80 
  for(i = 0; i < 256; i++)
...
80105a94:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a97:	c7 05 c2 51 11 80 08 	movl   $0xef000008,0x801151c2
80105a9e:	00 00 ef 
  initlock(&tickslock, "time");
80105aa1:	68 49 7b 10 80       	push   $0x80107b49
80105aa6:	68 80 4f 11 80       	push   $0x80114f80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105aab:	66 a3 c0 51 11 80    	mov    %ax,0x801151c0
80105ab1:	c1 e8 10             	shr    $0x10,%eax
80105ab4:	66 a3 c6 51 11 80    	mov    %ax,0x801151c6
  initlock(&tickslock, "time");
80105aba:	e8 71 ea ff ff       	call   80104530 <initlock>
}
...
80105adb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105adf:	b8 c0 4f 11 80       	mov    $0x80114fc0,%eax
...
80105b20:	ff 24 85 f0 7b 10 80 	jmp    *-0x7fef8410(,%eax,4)
...
80105b30:	e8 db dc ff ff       	call   80103810 <myproc>
...
80105b50:	e8 9b dc ff ff       	call   801037f0 <cpuid>
...
80105b61:	e8 aa dc ff ff       	call   80103810 <myproc>
80105b66:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105b69:	e8 a2 dc ff ff       	call   80103810 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105b85:	68 ac 7b 10 80       	push   $0x80107bac
80105b8a:	e8 d1 aa ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105b8f:	83 c4 20             	add    $0x20,%esp
80105b92:	e8 79 dc ff ff       	call   80103810 <myproc>
...
80105b9e:	e8 6d dc ff ff       	call   80103810 <myproc>
80105ba3:	85 c0                	test   %eax,%eax
80105ba5:	74 1d                	je     80105bc4 <trap+0xc4>
80105ba7:	e8 64 dc ff ff       	call   80103810 <myproc>
...
80105bc4:	e8 47 dc ff ff       	call   80103810 <myproc>
80105bc9:	85 c0                	test   %eax,%eax
80105bcb:	74 0b                	je     80105bd8 <trap+0xd8>
80105bcd:	e8 3e dc ff ff       	call   80103810 <myproc>
...
80105be1:	e8 2a dc ff ff       	call   80103810 <myproc>
...
80105c1d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105c20:	e8 4b ef ff ff       	call   80104b70 <syscall>
    if(myproc()->killed)
80105c25:	e8 e6 db ff ff       	call   80103810 <myproc>
...
80105c74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105c78:	e8 a3 c9 ff ff       	call   80102620 <kbdintr>
    lapiceoi();
...
80105cbf:	e8 2c db ff ff       	call   801037f0 <cpuid>
80105cc4:	56                   	push   %esi
80105cc5:	53                   	push   %ebx
80105cc6:	50                   	push   %eax
80105cc7:	68 54 7b 10 80       	push   $0x80107b54
80105ccc:	e8 8f a9 ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105cd1:	e8 8a ca ff ff       	call   80102760 <lapiceoi>
    break;
80105cd6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cd9:	e8 32 db ff ff       	call   80103810 <myproc>
...
80105cfa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d00:	e8 7b df ff ff       	call   80103c80 <exit>
80105d05:	e9 0e ff ff ff       	jmp    80105c18 <trap+0x118>
80105d0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105d10:	e8 6b df ff ff       	call   80103c80 <exit>
80105d15:	e9 aa fe ff ff       	jmp    80105bc4 <trap+0xc4>
80105d1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105d20:	83 ec 0c             	sub    $0xc,%esp
80105d23:	68 80 4f 11 80       	push   $0x80114f80
80105d28:	e8 43 e9 ff ff       	call   80104670 <acquire>
      wakeup(&ticks);
80105d2d:	c7 04 24 c0 57 11 80 	movl   $0x801157c0,(%esp)
      ticks++;
80105d34:	83 05 c0 57 11 80 01 	addl   $0x1,0x801157c0
      wakeup(&ticks);
80105d3b:	e8 80 e2 ff ff       	call   80103fc0 <wakeup>
      release(&tickslock);
80105d40:	c7 04 24 80 4f 11 80 	movl   $0x80114f80,(%esp)
80105d47:	e8 e4 e9 ff ff       	call   80104730 <release>
80105d4c:	83 c4 10             	add    $0x10,%esp
80105d4f:	e9 09 ff ff ff       	jmp    80105c5d <trap+0x15d>
80105d54:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d57:	e8 94 da ff ff       	call   801037f0 <cpuid>
...
80105d65:	68 78 7b 10 80       	push   $0x80107b78
80105d6a:	e8 f1 a8 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105d6f:	83 c4 14             	add    $0x14,%esp
80105d72:	68 4e 7b 10 80       	push   $0x80107b4e
...
80105e6c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e6f:	bb 70 7c 10 80       	mov    $0x80107c70,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105f07:	6a 00                	push   $0x0
  jmp alltraps
80105f09:	e9 1b fb ff ff       	jmp    80105a29 <alltraps>
...
80105f10:	6a 01                	push   $0x1
  jmp alltraps
80105f12:	e9 12 fb ff ff       	jmp    80105a29 <alltraps>
...
80105f19:	6a 02                	push   $0x2
  jmp alltraps
80105f1b:	e9 09 fb ff ff       	jmp    80105a29 <alltraps>
...
80105f22:	6a 03                	push   $0x3
  jmp alltraps
80105f24:	e9 00 fb ff ff       	jmp    80105a29 <alltraps>
...
80105f2b:	6a 04                	push   $0x4
  jmp alltraps
80105f2d:	e9 f7 fa ff ff       	jmp    80105a29 <alltraps>
...
80105f34:	6a 05                	push   $0x5
  jmp alltraps
80105f36:	e9 ee fa ff ff       	jmp    80105a29 <alltraps>
...
80105f3d:	6a 06                	push   $0x6
  jmp alltraps
80105f3f:	e9 e5 fa ff ff       	jmp    80105a29 <alltraps>
...
80105f46:	6a 07                	push   $0x7
  jmp alltraps
80105f48:	e9 dc fa ff ff       	jmp    80105a29 <alltraps>
...
80105f4d:	6a 08                	push   $0x8
  jmp alltraps
80105f4f:	e9 d5 fa ff ff       	jmp    80105a29 <alltraps>
...
80105f56:	6a 09                	push   $0x9
  jmp alltraps
80105f58:	e9 cc fa ff ff       	jmp    80105a29 <alltraps>
...
80105f5d:	6a 0a                	push   $0xa
  jmp alltraps
80105f5f:	e9 c5 fa ff ff       	jmp    80105a29 <alltraps>
...
80105f64:	6a 0b                	push   $0xb
  jmp alltraps
80105f66:	e9 be fa ff ff       	jmp    80105a29 <alltraps>
...
80105f6b:	6a 0c                	push   $0xc
  jmp alltraps
80105f6d:	e9 b7 fa ff ff       	jmp    80105a29 <alltraps>
...
80105f72:	6a 0d                	push   $0xd
  jmp alltraps
80105f74:	e9 b0 fa ff ff       	jmp    80105a29 <alltraps>
...
80105f79:	6a 0e                	push   $0xe
  jmp alltraps
80105f7b:	e9 a9 fa ff ff       	jmp    80105a29 <alltraps>
...
80105f82:	6a 0f                	push   $0xf
  jmp alltraps
80105f84:	e9 a0 fa ff ff       	jmp    80105a29 <alltraps>
...
80105f8b:	6a 10                	push   $0x10
  jmp alltraps
80105f8d:	e9 97 fa ff ff       	jmp    80105a29 <alltraps>
...
80105f92:	6a 11                	push   $0x11
  jmp alltraps
80105f94:	e9 90 fa ff ff       	jmp    80105a29 <alltraps>
...
80105f9b:	6a 12                	push   $0x12
  jmp alltraps
80105f9d:	e9 87 fa ff ff       	jmp    80105a29 <alltraps>
...
80105fa4:	6a 13                	push   $0x13
  jmp alltraps
80105fa6:	e9 7e fa ff ff       	jmp    80105a29 <alltraps>
...
80105fad:	6a 14                	push   $0x14
  jmp alltraps
80105faf:	e9 75 fa ff ff       	jmp    80105a29 <alltraps>
...
80105fb6:	6a 15                	push   $0x15
  jmp alltraps
80105fb8:	e9 6c fa ff ff       	jmp    80105a29 <alltraps>
...
80105fbf:	6a 16                	push   $0x16
  jmp alltraps
80105fc1:	e9 63 fa ff ff       	jmp    80105a29 <alltraps>
...
80105fc8:	6a 17                	push   $0x17
  jmp alltraps
80105fca:	e9 5a fa ff ff       	jmp    80105a29 <alltraps>
...
80105fd1:	6a 18                	push   $0x18
  jmp alltraps
80105fd3:	e9 51 fa ff ff       	jmp    80105a29 <alltraps>
...
80105fda:	6a 19                	push   $0x19
  jmp alltraps
80105fdc:	e9 48 fa ff ff       	jmp    80105a29 <alltraps>
...
80105fe3:	6a 1a                	push   $0x1a
  jmp alltraps
80105fe5:	e9 3f fa ff ff       	jmp    80105a29 <alltraps>
...
80105fec:	6a 1b                	push   $0x1b
  jmp alltraps
80105fee:	e9 36 fa ff ff       	jmp    80105a29 <alltraps>
...
80105ff5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ff7:	e9 2d fa ff ff       	jmp    80105a29 <alltraps>
...
80105ffe:	6a 1d                	push   $0x1d
  jmp alltraps
80106000:	e9 24 fa ff ff       	jmp    80105a29 <alltraps>
...
80106007:	6a 1e                	push   $0x1e
  jmp alltraps
80106009:	e9 1b fa ff ff       	jmp    80105a29 <alltraps>
...
80106010:	6a 1f                	push   $0x1f
  jmp alltraps
80106012:	e9 12 fa ff ff       	jmp    80105a29 <alltraps>
...
80106019:	6a 20                	push   $0x20
  jmp alltraps
8010601b:	e9 09 fa ff ff       	jmp    80105a29 <alltraps>
...
80106022:	6a 21                	push   $0x21
  jmp alltraps
80106024:	e9 00 fa ff ff       	jmp    80105a29 <alltraps>
...
8010602b:	6a 22                	push   $0x22
  jmp alltraps
8010602d:	e9 f7 f9 ff ff       	jmp    80105a29 <alltraps>
...
80106034:	6a 23                	push   $0x23
  jmp alltraps
80106036:	e9 ee f9 ff ff       	jmp    80105a29 <alltraps>
...
8010603d:	6a 24                	push   $0x24
  jmp alltraps
8010603f:	e9 e5 f9 ff ff       	jmp    80105a29 <alltraps>
...
80106046:	6a 25                	push   $0x25
  jmp alltraps
80106048:	e9 dc f9 ff ff       	jmp    80105a29 <alltraps>
...
8010604f:	6a 26                	push   $0x26
  jmp alltraps
80106051:	e9 d3 f9 ff ff       	jmp    80105a29 <alltraps>
...
80106058:	6a 27                	push   $0x27
  jmp alltraps
8010605a:	e9 ca f9 ff ff       	jmp    80105a29 <alltraps>
...
80106061:	6a 28                	push   $0x28
  jmp alltraps
80106063:	e9 c1 f9 ff ff       	jmp    80105a29 <alltraps>
...
8010606a:	6a 29                	push   $0x29
  jmp alltraps
8010606c:	e9 b8 f9 ff ff       	jmp    80105a29 <alltraps>
...
80106073:	6a 2a                	push   $0x2a
  jmp alltraps
80106075:	e9 af f9 ff ff       	jmp    80105a29 <alltraps>
...
8010607c:	6a 2b                	push   $0x2b
  jmp alltraps
8010607e:	e9 a6 f9 ff ff       	jmp    80105a29 <alltraps>
...
80106085:	6a 2c                	push   $0x2c
  jmp alltraps
80106087:	e9 9d f9 ff ff       	jmp    80105a29 <alltraps>
...
8010608e:	6a 2d                	push   $0x2d
  jmp alltraps
80106090:	e9 94 f9 ff ff       	jmp    80105a29 <alltraps>
...
80106097:	6a 2e                	push   $0x2e
  jmp alltraps
80106099:	e9 8b f9 ff ff       	jmp    80105a29 <alltraps>
...
801060a0:	6a 2f                	push   $0x2f
  jmp alltraps
801060a2:	e9 82 f9 ff ff       	jmp    80105a29 <alltraps>
...
801060a9:	6a 30                	push   $0x30
  jmp alltraps
801060ab:	e9 79 f9 ff ff       	jmp    80105a29 <alltraps>
...
801060b2:	6a 31                	push   $0x31
  jmp alltraps
801060b4:	e9 70 f9 ff ff       	jmp    80105a29 <alltraps>
...
801060bb:	6a 32                	push   $0x32
  jmp alltraps
801060bd:	e9 67 f9 ff ff       	jmp    80105a29 <alltraps>
...
801060c4:	6a 33                	push   $0x33
  jmp alltraps
801060c6:	e9 5e f9 ff ff       	jmp    80105a29 <alltraps>
...
801060cd:	6a 34                	push   $0x34
  jmp alltraps
801060cf:	e9 55 f9 ff ff       	jmp    80105a29 <alltraps>
...
801060d6:	6a 35                	push   $0x35
  jmp alltraps
801060d8:	e9 4c f9 ff ff       	jmp    80105a29 <alltraps>
...
801060df:	6a 36                	push   $0x36
  jmp alltraps
801060e1:	e9 43 f9 ff ff       	jmp    80105a29 <alltraps>
...
801060e8:	6a 37                	push   $0x37
  jmp alltraps
801060ea:	e9 3a f9 ff ff       	jmp    80105a29 <alltraps>
...
801060f1:	6a 38                	push   $0x38
  jmp alltraps
801060f3:	e9 31 f9 ff ff       	jmp    80105a29 <alltraps>
...
801060fa:	6a 39                	push   $0x39
  jmp alltraps
801060fc:	e9 28 f9 ff ff       	jmp    80105a29 <alltraps>
...
80106103:	6a 3a                	push   $0x3a
  jmp alltraps
80106105:	e9 1f f9 ff ff       	jmp    80105a29 <alltraps>
...
8010610c:	6a 3b                	push   $0x3b
  jmp alltraps
8010610e:	e9 16 f9 ff ff       	jmp    80105a29 <alltraps>
...
80106115:	6a 3c                	push   $0x3c
  jmp alltraps
80106117:	e9 0d f9 ff ff       	jmp    80105a29 <alltraps>
...
8010611e:	6a 3d                	push   $0x3d
  jmp alltraps
80106120:	e9 04 f9 ff ff       	jmp    80105a29 <alltraps>
...
80106127:	6a 3e                	push   $0x3e
  jmp alltraps
80106129:	e9 fb f8 ff ff       	jmp    80105a29 <alltraps>
...
80106130:	6a 3f                	push   $0x3f
  jmp alltraps
80106132:	e9 f2 f8 ff ff       	jmp    80105a29 <alltraps>
...
80106139:	6a 40                	push   $0x40
  jmp alltraps
8010613b:	e9 e9 f8 ff ff       	jmp    80105a29 <alltraps>
...
80106142:	6a 41                	push   $0x41
  jmp alltraps
80106144:	e9 e0 f8 ff ff       	jmp    80105a29 <alltraps>
...
8010614b:	6a 42                	push   $0x42
  jmp alltraps
8010614d:	e9 d7 f8 ff ff       	jmp    80105a29 <alltraps>
...
80106154:	6a 43                	push   $0x43
  jmp alltraps
80106156:	e9 ce f8 ff ff       	jmp    80105a29 <alltraps>
...
8010615d:	6a 44                	push   $0x44
  jmp alltraps
8010615f:	e9 c5 f8 ff ff       	jmp    80105a29 <alltraps>
...
80106166:	6a 45                	push   $0x45
  jmp alltraps
80106168:	e9 bc f8 ff ff       	jmp    80105a29 <alltraps>
...
8010616f:	6a 46                	push   $0x46
  jmp alltraps
80106171:	e9 b3 f8 ff ff       	jmp    80105a29 <alltraps>
...
80106178:	6a 47                	push   $0x47
  jmp alltraps
8010617a:	e9 aa f8 ff ff       	jmp    80105a29 <alltraps>
...
80106181:	6a 48                	push   $0x48
  jmp alltraps
80106183:	e9 a1 f8 ff ff       	jmp    80105a29 <alltraps>
...
8010618a:	6a 49                	push   $0x49
  jmp alltraps
8010618c:	e9 98 f8 ff ff       	jmp    80105a29 <alltraps>
...
80106193:	6a 4a                	push   $0x4a
  jmp alltraps
80106195:	e9 8f f8 ff ff       	jmp    80105a29 <alltraps>
...
8010619c:	6a 4b                	push   $0x4b
  jmp alltraps
8010619e:	e9 86 f8 ff ff       	jmp    80105a29 <alltraps>
...
801061a5:	6a 4c                	push   $0x4c
  jmp alltraps
801061a7:	e9 7d f8 ff ff       	jmp    80105a29 <alltraps>
...
801061ae:	6a 4d                	push   $0x4d
  jmp alltraps
801061b0:	e9 74 f8 ff ff       	jmp    80105a29 <alltraps>
...
801061b7:	6a 4e                	push   $0x4e
  jmp alltraps
801061b9:	e9 6b f8 ff ff       	jmp    80105a29 <alltraps>
...
801061c0:	6a 4f                	push   $0x4f
  jmp alltraps
801061c2:	e9 62 f8 ff ff       	jmp    80105a29 <alltraps>
...
801061c9:	6a 50                	push   $0x50
  jmp alltraps
801061cb:	e9 59 f8 ff ff       	jmp    80105a29 <alltraps>
...
801061d2:	6a 51                	push   $0x51
  jmp alltraps
801061d4:	e9 50 f8 ff ff       	jmp    80105a29 <alltraps>
...
801061db:	6a 52                	push   $0x52
  jmp alltraps
801061dd:	e9 47 f8 ff ff       	jmp    80105a29 <alltraps>
...
801061e4:	6a 53                	push   $0x53
  jmp alltraps
801061e6:	e9 3e f8 ff ff       	jmp    80105a29 <alltraps>
...
801061ed:	6a 54                	push   $0x54
  jmp alltraps
801061ef:	e9 35 f8 ff ff       	jmp    80105a29 <alltraps>
...
801061f6:	6a 55                	push   $0x55
  jmp alltraps
801061f8:	e9 2c f8 ff ff       	jmp    80105a29 <alltraps>
...
801061ff:	6a 56                	push   $0x56
  jmp alltraps
80106201:	e9 23 f8 ff ff       	jmp    80105a29 <alltraps>
...
80106208:	6a 57                	push   $0x57
  jmp alltraps
8010620a:	e9 1a f8 ff ff       	jmp    80105a29 <alltraps>
...
80106211:	6a 58                	push   $0x58
  jmp alltraps
80106213:	e9 11 f8 ff ff       	jmp    80105a29 <alltraps>
...
8010621a:	6a 59                	push   $0x59
  jmp alltraps
8010621c:	e9 08 f8 ff ff       	jmp    80105a29 <alltraps>
...
80106223:	6a 5a                	push   $0x5a
  jmp alltraps
80106225:	e9 ff f7 ff ff       	jmp    80105a29 <alltraps>
...
8010622c:	6a 5b                	push   $0x5b
  jmp alltraps
8010622e:	e9 f6 f7 ff ff       	jmp    80105a29 <alltraps>
...
80106235:	6a 5c                	push   $0x5c
  jmp alltraps
80106237:	e9 ed f7 ff ff       	jmp    80105a29 <alltraps>
...
8010623e:	6a 5d                	push   $0x5d
  jmp alltraps
80106240:	e9 e4 f7 ff ff       	jmp    80105a29 <alltraps>
...
80106247:	6a 5e                	push   $0x5e
  jmp alltraps
80106249:	e9 db f7 ff ff       	jmp    80105a29 <alltraps>
...
80106250:	6a 5f                	push   $0x5f
  jmp alltraps
80106252:	e9 d2 f7 ff ff       	jmp    80105a29 <alltraps>
...
80106259:	6a 60                	push   $0x60
  jmp alltraps
8010625b:	e9 c9 f7 ff ff       	jmp    80105a29 <alltraps>
...
80106262:	6a 61                	push   $0x61
  jmp alltraps
80106264:	e9 c0 f7 ff ff       	jmp    80105a29 <alltraps>
...
8010626b:	6a 62                	push   $0x62
  jmp alltraps
8010626d:	e9 b7 f7 ff ff       	jmp    80105a29 <alltraps>
...
80106274:	6a 63                	push   $0x63
  jmp alltraps
80106276:	e9 ae f7 ff ff       	jmp    80105a29 <alltraps>
...
8010627d:	6a 64                	push   $0x64
  jmp alltraps
8010627f:	e9 a5 f7 ff ff       	jmp    80105a29 <alltraps>
...
80106286:	6a 65                	push   $0x65
  jmp alltraps
80106288:	e9 9c f7 ff ff       	jmp    80105a29 <alltraps>
...
8010628f:	6a 66                	push   $0x66
  jmp alltraps
80106291:	e9 93 f7 ff ff       	jmp    80105a29 <alltraps>
...
80106298:	6a 67                	push   $0x67
  jmp alltraps
8010629a:	e9 8a f7 ff ff       	jmp    80105a29 <alltraps>
...
801062a1:	6a 68                	push   $0x68
  jmp alltraps
801062a3:	e9 81 f7 ff ff       	jmp    80105a29 <alltraps>
...
801062aa:	6a 69                	push   $0x69
  jmp alltraps
801062ac:	e9 78 f7 ff ff       	jmp    80105a29 <alltraps>
...
801062b3:	6a 6a                	push   $0x6a
  jmp alltraps
801062b5:	e9 6f f7 ff ff       	jmp    80105a29 <alltraps>
...
801062bc:	6a 6b                	push   $0x6b
  jmp alltraps
801062be:	e9 66 f7 ff ff       	jmp    80105a29 <alltraps>
...
801062c5:	6a 6c                	push   $0x6c
  jmp alltraps
801062c7:	e9 5d f7 ff ff       	jmp    80105a29 <alltraps>
...
801062ce:	6a 6d                	push   $0x6d
  jmp alltraps
801062d0:	e9 54 f7 ff ff       	jmp    80105a29 <alltraps>
...
801062d7:	6a 6e                	push   $0x6e
  jmp alltraps
801062d9:	e9 4b f7 ff ff       	jmp    80105a29 <alltraps>
...
801062e0:	6a 6f                	push   $0x6f
  jmp alltraps
801062e2:	e9 42 f7 ff ff       	jmp    80105a29 <alltraps>
...
801062e9:	6a 70                	push   $0x70
  jmp alltraps
801062eb:	e9 39 f7 ff ff       	jmp    80105a29 <alltraps>
...
801062f2:	6a 71                	push   $0x71
  jmp alltraps
801062f4:	e9 30 f7 ff ff       	jmp    80105a29 <alltraps>
...
801062fb:	6a 72                	push   $0x72
  jmp alltraps
801062fd:	e9 27 f7 ff ff       	jmp    80105a29 <alltraps>
...
80106304:	6a 73                	push   $0x73
  jmp alltraps
80106306:	e9 1e f7 ff ff       	jmp    80105a29 <alltraps>
...
8010630d:	6a 74                	push   $0x74
  jmp alltraps
8010630f:	e9 15 f7 ff ff       	jmp    80105a29 <alltraps>
...
80106316:	6a 75                	push   $0x75
  jmp alltraps
80106318:	e9 0c f7 ff ff       	jmp    80105a29 <alltraps>
...
8010631f:	6a 76                	push   $0x76
  jmp alltraps
80106321:	e9 03 f7 ff ff       	jmp    80105a29 <alltraps>
...
80106328:	6a 77                	push   $0x77
  jmp alltraps
8010632a:	e9 fa f6 ff ff       	jmp    80105a29 <alltraps>
...
80106331:	6a 78                	push   $0x78
  jmp alltraps
80106333:	e9 f1 f6 ff ff       	jmp    80105a29 <alltraps>
...
8010633a:	6a 79                	push   $0x79
  jmp alltraps
8010633c:	e9 e8 f6 ff ff       	jmp    80105a29 <alltraps>
...
80106343:	6a 7a                	push   $0x7a
  jmp alltraps
80106345:	e9 df f6 ff ff       	jmp    80105a29 <alltraps>
...
8010634c:	6a 7b                	push   $0x7b
  jmp alltraps
8010634e:	e9 d6 f6 ff ff       	jmp    80105a29 <alltraps>
...
80106355:	6a 7c                	push   $0x7c
  jmp alltraps
80106357:	e9 cd f6 ff ff       	jmp    80105a29 <alltraps>
...
8010635e:	6a 7d                	push   $0x7d
  jmp alltraps
80106360:	e9 c4 f6 ff ff       	jmp    80105a29 <alltraps>
...
80106367:	6a 7e                	push   $0x7e
  jmp alltraps
80106369:	e9 bb f6 ff ff       	jmp    80105a29 <alltraps>
...
80106370:	6a 7f                	push   $0x7f
  jmp alltraps
80106372:	e9 b2 f6 ff ff       	jmp    80105a29 <alltraps>
...
80106379:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010637e:	e9 a6 f6 ff ff       	jmp    80105a29 <alltraps>
...
80106385:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010638a:	e9 9a f6 ff ff       	jmp    80105a29 <alltraps>
...
80106391:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106396:	e9 8e f6 ff ff       	jmp    80105a29 <alltraps>
...
8010639d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063a2:	e9 82 f6 ff ff       	jmp    80105a29 <alltraps>
...
801063a9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063ae:	e9 76 f6 ff ff       	jmp    80105a29 <alltraps>
...
801063b5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063ba:	e9 6a f6 ff ff       	jmp    80105a29 <alltraps>
...
801063c1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801063c6:	e9 5e f6 ff ff       	jmp    80105a29 <alltraps>
...
801063cd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801063d2:	e9 52 f6 ff ff       	jmp    80105a29 <alltraps>
...
801063d9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801063de:	e9 46 f6 ff ff       	jmp    80105a29 <alltraps>
...
801063e5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801063ea:	e9 3a f6 ff ff       	jmp    80105a29 <alltraps>
...
801063f1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801063f6:	e9 2e f6 ff ff       	jmp    80105a29 <alltraps>
...
801063fd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106402:	e9 22 f6 ff ff       	jmp    80105a29 <alltraps>
...
80106409:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010640e:	e9 16 f6 ff ff       	jmp    80105a29 <alltraps>
...
80106415:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010641a:	e9 0a f6 ff ff       	jmp    80105a29 <alltraps>
...
80106421:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106426:	e9 fe f5 ff ff       	jmp    80105a29 <alltraps>
...
8010642d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106432:	e9 f2 f5 ff ff       	jmp    80105a29 <alltraps>
...
80106439:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010643e:	e9 e6 f5 ff ff       	jmp    80105a29 <alltraps>
...
80106445:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010644a:	e9 da f5 ff ff       	jmp    80105a29 <alltraps>
...
80106451:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106456:	e9 ce f5 ff ff       	jmp    80105a29 <alltraps>
...
8010645d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106462:	e9 c2 f5 ff ff       	jmp    80105a29 <alltraps>
...
80106469:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010646e:	e9 b6 f5 ff ff       	jmp    80105a29 <alltraps>
...
80106475:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010647a:	e9 aa f5 ff ff       	jmp    80105a29 <alltraps>
...
80106481:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106486:	e9 9e f5 ff ff       	jmp    80105a29 <alltraps>
...
8010648d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106492:	e9 92 f5 ff ff       	jmp    80105a29 <alltraps>
...
80106499:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010649e:	e9 86 f5 ff ff       	jmp    80105a29 <alltraps>
...
801064a5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064aa:	e9 7a f5 ff ff       	jmp    80105a29 <alltraps>
...
801064b1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064b6:	e9 6e f5 ff ff       	jmp    80105a29 <alltraps>
...
801064bd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801064c2:	e9 62 f5 ff ff       	jmp    80105a29 <alltraps>
...
801064c9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801064ce:	e9 56 f5 ff ff       	jmp    80105a29 <alltraps>
...
801064d5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801064da:	e9 4a f5 ff ff       	jmp    80105a29 <alltraps>
...
801064e1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801064e6:	e9 3e f5 ff ff       	jmp    80105a29 <alltraps>
...
801064ed:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801064f2:	e9 32 f5 ff ff       	jmp    80105a29 <alltraps>
...
801064f9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801064fe:	e9 26 f5 ff ff       	jmp    80105a29 <alltraps>
...
80106505:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010650a:	e9 1a f5 ff ff       	jmp    80105a29 <alltraps>
...
80106511:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106516:	e9 0e f5 ff ff       	jmp    80105a29 <alltraps>
...
8010651d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106522:	e9 02 f5 ff ff       	jmp    80105a29 <alltraps>
...
80106529:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010652e:	e9 f6 f4 ff ff       	jmp    80105a29 <alltraps>
...
80106535:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010653a:	e9 ea f4 ff ff       	jmp    80105a29 <alltraps>
...
80106541:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106546:	e9 de f4 ff ff       	jmp    80105a29 <alltraps>
...
8010654d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106552:	e9 d2 f4 ff ff       	jmp    80105a29 <alltraps>
...
80106559:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010655e:	e9 c6 f4 ff ff       	jmp    80105a29 <alltraps>
...
80106565:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010656a:	e9 ba f4 ff ff       	jmp    80105a29 <alltraps>
...
80106571:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106576:	e9 ae f4 ff ff       	jmp    80105a29 <alltraps>
...
8010657d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106582:	e9 a2 f4 ff ff       	jmp    80105a29 <alltraps>
...
80106589:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010658e:	e9 96 f4 ff ff       	jmp    80105a29 <alltraps>
...
80106595:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010659a:	e9 8a f4 ff ff       	jmp    80105a29 <alltraps>
...
801065a1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065a6:	e9 7e f4 ff ff       	jmp    80105a29 <alltraps>
...
801065ad:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065b2:	e9 72 f4 ff ff       	jmp    80105a29 <alltraps>
...
801065b9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065be:	e9 66 f4 ff ff       	jmp    80105a29 <alltraps>
...
801065c5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801065ca:	e9 5a f4 ff ff       	jmp    80105a29 <alltraps>
...
801065d1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801065d6:	e9 4e f4 ff ff       	jmp    80105a29 <alltraps>
...
801065dd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801065e2:	e9 42 f4 ff ff       	jmp    80105a29 <alltraps>
...
801065e9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801065ee:	e9 36 f4 ff ff       	jmp    80105a29 <alltraps>
...
801065f5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801065fa:	e9 2a f4 ff ff       	jmp    80105a29 <alltraps>
...
80106601:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106606:	e9 1e f4 ff ff       	jmp    80105a29 <alltraps>
...
8010660d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106612:	e9 12 f4 ff ff       	jmp    80105a29 <alltraps>
...
80106619:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010661e:	e9 06 f4 ff ff       	jmp    80105a29 <alltraps>
...
80106625:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010662a:	e9 fa f3 ff ff       	jmp    80105a29 <alltraps>
...
80106631:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106636:	e9 ee f3 ff ff       	jmp    80105a29 <alltraps>
...
8010663d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106642:	e9 e2 f3 ff ff       	jmp    80105a29 <alltraps>
...
80106649:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010664e:	e9 d6 f3 ff ff       	jmp    80105a29 <alltraps>
...
80106655:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010665a:	e9 ca f3 ff ff       	jmp    80105a29 <alltraps>
...
80106661:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106666:	e9 be f3 ff ff       	jmp    80105a29 <alltraps>
...
8010666d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106672:	e9 b2 f3 ff ff       	jmp    80105a29 <alltraps>
...
80106679:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010667e:	e9 a6 f3 ff ff       	jmp    80105a29 <alltraps>
...
80106685:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010668a:	e9 9a f3 ff ff       	jmp    80105a29 <alltraps>
...
80106691:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106696:	e9 8e f3 ff ff       	jmp    80105a29 <alltraps>
...
8010669d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066a2:	e9 82 f3 ff ff       	jmp    80105a29 <alltraps>
...
801066a9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066ae:	e9 76 f3 ff ff       	jmp    80105a29 <alltraps>
...
801066b5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066ba:	e9 6a f3 ff ff       	jmp    80105a29 <alltraps>
...
801066c1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801066c6:	e9 5e f3 ff ff       	jmp    80105a29 <alltraps>
...
801066cd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801066d2:	e9 52 f3 ff ff       	jmp    80105a29 <alltraps>
...
801066d9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801066de:	e9 46 f3 ff ff       	jmp    80105a29 <alltraps>
...
801066e5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801066ea:	e9 3a f3 ff ff       	jmp    80105a29 <alltraps>
...
801066f1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801066f6:	e9 2e f3 ff ff       	jmp    80105a29 <alltraps>
...
801066fd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106702:	e9 22 f3 ff ff       	jmp    80105a29 <alltraps>
...
80106709:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010670e:	e9 16 f3 ff ff       	jmp    80105a29 <alltraps>
...
80106715:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010671a:	e9 0a f3 ff ff       	jmp    80105a29 <alltraps>
...
80106721:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106726:	e9 fe f2 ff ff       	jmp    80105a29 <alltraps>
...
8010672d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106732:	e9 f2 f2 ff ff       	jmp    80105a29 <alltraps>
...
80106739:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010673e:	e9 e6 f2 ff ff       	jmp    80105a29 <alltraps>
...
80106745:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010674a:	e9 da f2 ff ff       	jmp    80105a29 <alltraps>
...
80106751:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106756:	e9 ce f2 ff ff       	jmp    80105a29 <alltraps>
...
8010675d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106762:	e9 c2 f2 ff ff       	jmp    80105a29 <alltraps>
...
80106769:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010676e:	e9 b6 f2 ff ff       	jmp    80105a29 <alltraps>
...
80106775:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010677a:	e9 aa f2 ff ff       	jmp    80105a29 <alltraps>
...
80106781:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106786:	e9 9e f2 ff ff       	jmp    80105a29 <alltraps>
...
8010678d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106792:	e9 92 f2 ff ff       	jmp    80105a29 <alltraps>
...
80106799:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010679e:	e9 86 f2 ff ff       	jmp    80105a29 <alltraps>
...
801067a5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067aa:	e9 7a f2 ff ff       	jmp    80105a29 <alltraps>
...
801067b1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067b6:	e9 6e f2 ff ff       	jmp    80105a29 <alltraps>
...
801067bd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801067c2:	e9 62 f2 ff ff       	jmp    80105a29 <alltraps>
...
801067c9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801067ce:	e9 56 f2 ff ff       	jmp    80105a29 <alltraps>
...
801067d5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801067da:	e9 4a f2 ff ff       	jmp    80105a29 <alltraps>
...
801067e1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801067e6:	e9 3e f2 ff ff       	jmp    80105a29 <alltraps>
...
801067ed:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801067f2:	e9 32 f2 ff ff       	jmp    80105a29 <alltraps>
...
801067f9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801067fe:	e9 26 f2 ff ff       	jmp    80105a29 <alltraps>
...
80106805:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010680a:	e9 1a f2 ff ff       	jmp    80105a29 <alltraps>
...
80106811:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106816:	e9 0e f2 ff ff       	jmp    80105a29 <alltraps>
...
8010681d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106822:	e9 02 f2 ff ff       	jmp    80105a29 <alltraps>
...
80106829:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010682e:	e9 f6 f1 ff ff       	jmp    80105a29 <alltraps>
...
80106835:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010683a:	e9 ea f1 ff ff       	jmp    80105a29 <alltraps>
...
80106841:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106846:	e9 de f1 ff ff       	jmp    80105a29 <alltraps>
...
8010684d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106852:	e9 d2 f1 ff ff       	jmp    80105a29 <alltraps>
...
80106859:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010685e:	e9 c6 f1 ff ff       	jmp    80105a29 <alltraps>
...
80106865:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010686a:	e9 ba f1 ff ff       	jmp    80105a29 <alltraps>
...
80106871:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106876:	e9 ae f1 ff ff       	jmp    80105a29 <alltraps>
...
8010687d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106882:	e9 a2 f1 ff ff       	jmp    80105a29 <alltraps>
...
80106889:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010688e:	e9 96 f1 ff ff       	jmp    80105a29 <alltraps>
...
80106895:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010689a:	e9 8a f1 ff ff       	jmp    80105a29 <alltraps>
...
801068a1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068a6:	e9 7e f1 ff ff       	jmp    80105a29 <alltraps>
...
801068ad:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068b2:	e9 72 f1 ff ff       	jmp    80105a29 <alltraps>
...
801068b9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068be:	e9 66 f1 ff ff       	jmp    80105a29 <alltraps>
...
801068c5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801068ca:	e9 5a f1 ff ff       	jmp    80105a29 <alltraps>
...
801068d1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801068d6:	e9 4e f1 ff ff       	jmp    80105a29 <alltraps>
...
801068dd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801068e2:	e9 42 f1 ff ff       	jmp    80105a29 <alltraps>
...
801068e9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801068ee:	e9 36 f1 ff ff       	jmp    80105a29 <alltraps>
...
801068f5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801068fa:	e9 2a f1 ff ff       	jmp    80105a29 <alltraps>
...
80106901:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106906:	e9 1e f1 ff ff       	jmp    80105a29 <alltraps>
...
8010690d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106912:	e9 12 f1 ff ff       	jmp    80105a29 <alltraps>
...
80106919:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010691e:	e9 06 f1 ff ff       	jmp    80105a29 <alltraps>
...
80106925:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010692a:	e9 fa f0 ff ff       	jmp    80105a29 <alltraps>
...
80106931:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106936:	e9 ee f0 ff ff       	jmp    80105a29 <alltraps>
...
8010693d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106942:	e9 e2 f0 ff ff       	jmp    80105a29 <alltraps>
...
80106949:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010694e:	e9 d6 f0 ff ff       	jmp    80105a29 <alltraps>
...
80106955:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010695a:	e9 ca f0 ff ff       	jmp    80105a29 <alltraps>
...
80106961:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106966:	e9 be f0 ff ff       	jmp    80105a29 <alltraps>
...
8010696d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106972:	e9 b2 f0 ff ff       	jmp    80105a29 <alltraps>
...
801069da:	e8 a1 dd ff ff       	call   80104780 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a7d:	68 78 7c 10 80       	push   $0x80107c78
...
80106b22:	68 e6 75 10 80       	push   $0x801075e6
...
80106b33:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b36:	e8 b5 cc ff ff       	call   801037f0 <cpuid>
...
80106b4a:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80106b51:	ff 00 00 
80106b54:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
80106b5b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b5e:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80106b65:	ff 00 00 
80106b68:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
80106b6f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b72:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80106b79:	ff 00 00 
80106b7c:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80106b83:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106b86:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
80106b8d:	ff 00 00 
80106b90:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80106b97:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106b9a:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80106bc0:	a1 c4 57 11 80       	mov    0x801157c4,%eax
{
...
80106c04:	0f 84 c2 00 00 00    	je     80106ccc <switchuvm+0xec>
  pushcli();
80106c0a:	e8 91 d9 ff ff       	call   801045a0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c0f:	e8 5c cb ff ff       	call   80103770 <mycpu>
80106c14:	89 c6                	mov    %eax,%esi
80106c16:	e8 55 cb ff ff       	call   80103770 <mycpu>
80106c1b:	89 c7                	mov    %eax,%edi
80106c1d:	e8 4e cb ff ff       	call   80103770 <mycpu>
80106c22:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c25:	83 c7 08             	add    $0x8,%edi
80106c28:	e8 43 cb ff ff       	call   80103770 <mycpu>
...
80106d1f:	e8 5c da ff ff       	call   80104780 <memset>
...
80106d50:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d51:	e9 da da ff ff       	jmp    80104830 <memmove>
    panic("inituvm: more than a page");
80106d56:	83 ec 0c             	sub    $0xc,%esp
80106d59:	68 bd 7c 10 80       	push   $0x80107cbd
...
80106e7b:	e8 00 d9 ff ff       	call   80104780 <memset>
...
80106ebd:	68 f5 7c 10 80       	push   $0x80107cf5
...
80106ef3:	68 0d 7d 10 80       	push   $0x80107d0d
...
80106ffc:	68 29 7d 10 80       	push   $0x80107d29
...
80107030:	e8 4b d7 ff ff       	call   80104780 <memset>
...
8010709b:	a3 c4 57 11 80       	mov    %eax,0x801157c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801070cf:	68 3a 7d 10 80       	push   $0x80107d3a
...
80107120:	e8 0b d7 ff ff       	call   80104830 <memmove>
...
801071b9:	68 5e 7d 10 80       	push   $0x80107d5e
801071be:	e8 cd 91 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801071c3:	83 ec 0c             	sub    $0xc,%esp
801071c6:	68 44 7d 10 80       	push   $0x80107d44
...
8010724f:	e8 dc d5 ff ff       	call   80104830 <memmove>
    len -= n;
    buf += n;
...
801072a0:	5d                   	pop    %ebp
801072a1:	c3                   	ret    
801072a2:	66 90                	xchg   %ax,%ax
801072a4:	66 90                	xchg   %ax,%ax
801072a6:	66 90                	xchg   %ax,%ax
801072a8:	66 90                	xchg   %ax,%ax
...
rand() {
	...
	unsigned int s = w;
	x = y;
801072b0:	8b 15 c8 a5 10 80    	mov    0x8010a5c8,%edx
	unsigned int t = x;
801072b6:	a1 cc a5 10 80       	mov    0x8010a5cc,%eax
	unsigned int s = w;
801072bb:	8b 0d c0 a5 10 80    	mov    0x8010a5c0,%ecx
rand() {
801072c1:	55                   	push   %ebp
	x = y;
801072c2:	89 15 cc a5 10 80    	mov    %edx,0x8010a5cc
	y = z;
801072c8:	8b 15 c4 a5 10 80    	mov    0x8010a5c4,%edx
rand() {
801072ce:	89 e5                	mov    %esp,%ebp
	z = s;
801072d0:	89 0d c4 a5 10 80    	mov    %ecx,0x8010a5c4
...
801072d6:	5d                   	pop    %ebp
	y = z;
801072d7:	89 15 c8 a5 10 80    	mov    %edx,0x8010a5c8
	t ^= t << 11;
801072dd:	89 c2                	mov    %eax,%edx
801072df:	c1 e2 0b             	shl    $0xb,%edx
801072e2:	31 c2                	xor    %eax,%edx
	return w = t ^ s ^ (s >> 19);
801072e4:	89 c8                	mov    %ecx,%eax
801072e6:	c1 e8 13             	shr    $0x13,%eax
801072e9:	31 c8                	xor    %ecx,%eax
801072eb:	31 d0                	xor    %edx,%eax
	t ^= t >> 8;
801072ed:	c1 ea 08             	shr    $0x8,%edx
	return w = t ^ s ^ (s >> 19);
801072f0:	31 d0                	xor    %edx,%eax
801072f2:	a3 c0 a5 10 80       	mov    %eax,0x8010a5c0
}
801072f7:	c3                   	ret    
801072f8:	90                   	nop
...
80107301:	8b 0d c0 a5 10 80    	mov    0x8010a5c0,%ecx
80107307:	89 e5                	mov    %esp,%ebp
80107309:	57                   	push   %edi
8010730a:	8b 3d c4 a5 10 80    	mov    0x8010a5c4,%edi
80107310:	56                   	push   %esi
80107311:	8b 45 08             	mov    0x8(%ebp),%eax
80107314:	53                   	push   %ebx
80107315:	8b 35 c8 a5 10 80    	mov    0x8010a5c8,%esi
	return w = t ^ s ^ (s >> 19);
8010731b:	bb 64 00 00 00       	mov    $0x64,%ebx
80107320:	eb 0c                	jmp    8010732e <srand+0x2e>
80107322:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80107328:	89 fe                	mov    %edi,%esi
8010732a:	89 cf                	mov    %ecx,%edi
8010732c:	89 d1                	mov    %edx,%ecx
	t ^= t << 11;
8010732e:	89 c2                	mov    %eax,%edx
80107330:	c1 e2 0b             	shl    $0xb,%edx
80107333:	31 c2                	xor    %eax,%edx
	return w = t ^ s ^ (s >> 19);
80107335:	89 c8                	mov    %ecx,%eax
80107337:	c1 e8 13             	shr    $0x13,%eax
8010733a:	31 d0                	xor    %edx,%eax
	t ^= t >> 8;
8010733c:	c1 ea 08             	shr    $0x8,%edx
	return w = t ^ s ^ (s >> 19);
8010733f:	31 c8                	xor    %ecx,%eax
80107341:	31 c2                	xor    %eax,%edx
	int i = 0;
	x = seed;

	for (i = 0; i < 100; ++i) {
80107343:	83 eb 01             	sub    $0x1,%ebx
80107346:	89 f0                	mov    %esi,%eax
80107348:	75 de                	jne    80107328 <srand+0x28>
		rand();
	}
}
8010734a:	5b                   	pop    %ebx
8010734b:	89 35 cc a5 10 80    	mov    %esi,0x8010a5cc
80107351:	89 3d c8 a5 10 80    	mov    %edi,0x8010a5c8
80107357:	5e                   	pop    %esi
80107358:	89 15 c0 a5 10 80    	mov    %edx,0x8010a5c0
8010735e:	89 0d c4 a5 10 80    	mov    %ecx,0x8010a5c4
80107364:	5f                   	pop    %edi
80107365:	5d                   	pop    %ebp
80107366:	c3                   	ret    
