...
int main(void) {
  ...
  10:	31 db                	xor    %ebx,%ebx
		printf(1, "%d: %d\n", i, rand() % max);
  12:	be 1f 85 eb 51       	mov    $0x51eb851f,%esi
int main(void) {
  17:	83 ec 18             	sub    $0x18,%esp
	srand(20160548);
  1a:	68 24 a0 33 01       	push   $0x133a024
  1f:	e8 8c 00 00 00       	call   b0 <srand>
  24:	83 c4 10             	add    $0x10,%esp
  27:	89 f6                	mov    %esi,%esi
  29:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
		printf(1, "%d: %d\n", i, rand() % max);
  30:	e8 2b 00 00 00       	call   60 <rand>
  35:	89 c1                	mov    %eax,%ecx
  37:	f7 e6                	mul    %esi
  39:	c1 ea 05             	shr    $0x5,%edx
  3c:	6b d2 64             	imul   $0x64,%edx,%edx
  ...
  4b:	6a 01                	push   $0x1
  4d:	e8 9e 04 00 00       	call   4f0 <printf>
	for (i = 0; i < 100; ++i) {
  52:	83 c4 10             	add    $0x10,%esp
  55:	83 fb 64             	cmp    $0x64,%ebx
  58:	75 d6                	jne    30 <main+0x30>
	}

	exit();
  5a:	e8 13 03 00 00       	call   372 <exit>
  5f:	90                   	nop
...
rand() {
	...
	unsigned int s = w;
	x = y;
  60:	8b 15 58 0b 00 00    	mov    0xb58,%edx
	unsigned int t = x;
  66:	a1 5c 0b 00 00       	mov    0xb5c,%eax
	unsigned int s = w;
  6b:	8b 0d 50 0b 00 00    	mov    0xb50,%ecx
rand() {
  71:	55                   	push   %ebp
	x = y;
  72:	89 15 5c 0b 00 00    	mov    %edx,0xb5c
	y = z;
  78:	8b 15 54 0b 00 00    	mov    0xb54,%edx
rand() {
  7e:	89 e5                	mov    %esp,%ebp
	z = s;
  80:	89 0d 54 0b 00 00    	mov    %ecx,0xb54
  ...
  86:	5d                   	pop    %ebp
	y = z;
  87:	89 15 58 0b 00 00    	mov    %edx,0xb58
	t ^= t << 11;
  8d:	89 c2                	mov    %eax,%edx
  8f:	c1 e2 0b             	shl    $0xb,%edx
  92:	31 c2                	xor    %eax,%edx
	return w = t ^ s ^ (s >> 19);
  94:	89 c8                	mov    %ecx,%eax
  96:	c1 e8 13             	shr    $0x13,%eax
  99:	31 c8                	xor    %ecx,%eax
  9b:	31 d0                	xor    %edx,%eax
	t ^= t >> 8;
  9d:	c1 ea 08             	shr    $0x8,%edx
	return w = t ^ s ^ (s >> 19);
  a0:	31 d0                	xor    %edx,%eax
  a2:	a3 50 0b 00 00       	mov    %eax,0xb50
}
  a7:	c3                   	ret    
  a8:	90                   	nop
...
srand(unsigned int seed) {
  b0:	55                   	push   %ebp
  b1:	8b 0d 50 0b 00 00    	mov    0xb50,%ecx
  b7:	89 e5                	mov    %esp,%ebp
  b9:	57                   	push   %edi
  ba:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
  c0:	56                   	push   %esi
  c1:	8b 45 08             	mov    0x8(%ebp),%eax
  c4:	53                   	push   %ebx
  c5:	8b 35 58 0b 00 00    	mov    0xb58,%esi
	return w = t ^ s ^ (s >> 19);
  cb:	bb 64 00 00 00       	mov    $0x64,%ebx
  d0:	eb 0c                	jmp    de <srand+0x2e>
  d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  d8:	89 fe                	mov    %edi,%esi
  da:	89 cf                	mov    %ecx,%edi
  dc:	89 d1                	mov    %edx,%ecx
	t ^= t << 11;
  de:	89 c2                	mov    %eax,%edx
  e0:	c1 e2 0b             	shl    $0xb,%edx
  e3:	31 c2                	xor    %eax,%edx
	return w = t ^ s ^ (s >> 19);
  e5:	89 c8                	mov    %ecx,%eax
  e7:	c1 e8 13             	shr    $0x13,%eax
  ea:	31 d0                	xor    %edx,%eax
	t ^= t >> 8;
  ec:	c1 ea 08             	shr    $0x8,%edx
	return w = t ^ s ^ (s >> 19);
  ef:	31 c8                	xor    %ecx,%eax
  f1:	31 c2                	xor    %eax,%edx
	int i = 0;
	x = seed;

	for (i = 0; i < 100; ++i) {
  f3:	83 eb 01             	sub    $0x1,%ebx
  f6:	89 f0                	mov    %esi,%eax
  f8:	75 de                	jne    d8 <srand+0x28>
		rand();
	}
}
  fa:	5b                   	pop    %ebx
  fb:	89 35 5c 0b 00 00    	mov    %esi,0xb5c
 101:	89 3d 58 0b 00 00    	mov    %edi,0xb58
 107:	5e                   	pop    %esi
 108:	89 15 50 0b 00 00    	mov    %edx,0xb50
 10e:	89 0d 54 0b 00 00    	mov    %ecx,0xb54
 114:	5f                   	pop    %edi
 115:	5d                   	pop    %ebp
 116:	c3                   	ret    
 ...
 459:	85 d2                	test   %edx,%edx
{
 ...
 487:	f7 f1                	div    %ecx
 489:	0f b6 92 58 08 00 00 	movzbl 0x858(%edx),%edx
  }while((x /= base) != 0);
 ...
 4c0:	e8 cd fe ff ff       	call   392 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 530:	e8 5d fe ff ff       	call   392 <write>
 ...
 5a8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 5aa:	e8 e3 fd ff ff       	call   392 <write>
  for(i = 0; fmt[i]; i++){
 ...
 643:	57                   	push   %edi
 644:	53                   	push   %ebx
 645:	e8 48 fd ff ff       	call   392 <write>
        while(*s != 0){
 ...
 697:	e8 f6 fc ff ff       	call   392 <write>
        ap++;
 ...
 6a4:	e9 8f fe ff ff       	jmp    538 <printf+0x48>
          s = "(null)";
 6a9:	bb 50 08 00 00       	mov    $0x850,%ebx
        while(*s != 0){
 ...
 6c1:	a1 60 0b 00 00       	mov    0xb60,%eax
{
 ...
 6fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ff:	a3 60 0b 00 00       	mov    %eax,0xb60
}
 704:	5b                   	pop    %ebx
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 7f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7f7:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 ...
 809:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 60 0b 00 00 64 	movl   $0xb64,0xb60
 817:	0b 00 00 
 81a:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 821:	0b 00 00 
    base.s.size = 0;
 824:	b8 64 0b 00 00       	mov    $0xb64,%eax
 829:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 830:	00 00 00 
